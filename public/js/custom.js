...
const programSeletion = document.getElementById("program");
const regForm = document.getElementById("demo-form");

programSeletion.addEventListener("change", function () {
	const fidicModules = document.querySelector(".fidic-modules");

	if (programSeletion.value == "Fidic Training Program") {

		fidicModules.style.display = "block"

	} else {
		fidicModules.style.display = "none"
	}
});
